        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight">Innovation Highlights</h2>
            </div>
            <button 
              onClick={() => onNavigate('category', 'all')}
              className="mt-6 md:mt-0 px-6 py-3 border-b-2 border-black dark:border-white text-black dark:text-white font-bold text-sm uppercase tracking-widest hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-600 dark:hover:border-blue-400 transition-colors"
            >
              See All Products
            </button>
          </div>
